    ...
    <>
      {isModalOpen && (
        <div onClick={toggleModal} className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-black">
          <div className='w-screen sm:max-w-sm md:max-w-xl lg:max-w-lg xl:max-w-lg 2xl:max-w-6xl'>
      ...
      <div className="items-center justify-center min-h-screen px-4 sm:px-20">
        <main className="flex flex-col items-center justify-center text-center">
          <h1 className="text-4xl sm:text-6xl py-4 text-purple-900">Astrophotography</h1>
          <div className="bg-white rounded overflow-hidden shadow-2xl">
          <div className='w-full sm:max-w-sm md:max-w-md lg:max-w-md xl:max-w-md 2xl:max-w-3xl'>
