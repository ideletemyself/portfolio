        ...
        >
          <div className='w-full'>
            <Image
              ...
              layout='responsive'
              sizes='(min-width: 1560px) 1128px, (min-width: 1280px) 936px, (min-width: 1040px) 744px, (min-width: 780px) 552px, (min-width: 640px) 456px, 93.75vw'
              style={{
                objectFit: 'contain',
              }}
              width={7028}
                    ...
                    <SwiperSlide key={index}>
                      <button className='flex h-full w-full items-center justify-center'>
                        <Image
                          src={image.src}
                          alt={image.alt}
                          sizes='(min-width: 1560px) 279px, (min-width: 1280px) 231px, (min-width: 1040px) 183px, (min-width: 780px) 135px, (min-width: 640px) 111px, (min-width: 460px) calc(21.88vw + 5px), 100vw'
                          style={{
                            objectFit: 'contain',
                          }}
                          width={4688}
